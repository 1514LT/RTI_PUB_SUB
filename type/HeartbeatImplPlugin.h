...
#ifndef HeartbeatImplPlugin_816432136_h
#define HeartbeatImplPlugin_816432136_h
...
NDDSUSERDllExport extern RTIBool
heartbeat_SatelliteStatus_cPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream, 
...
NDDSUSERDllExport extern unsigned int 
heartbeat_SatelliteStatus_cPlugin_get_serialized_sample_min_size(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment);
...
NDDSUSERDllExport extern unsigned int 
heartbeat_SatelliteStatus_cPlugin_get_serialized_key_max_size(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment);
...
NDDSUSERDllExport extern RTIBool 
heartbeat_SatelliteStatus_cPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    heartbeat_SatelliteStatus_c * sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
heartbeat_SatelliteStatus_cPluginSupport_print_data(
    const heartbeat_SatelliteStatus_c *sample, const char *desc, int indent_level);

#define heartbeat_TelemetryData_cPlugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
#define heartbeat_TelemetryData_cPlugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define heartbeat_TelemetryData_cPlugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

#define heartbeat_TelemetryData_cPlugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define heartbeat_TelemetryData_cPlugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

/* --------------------------------------------------------------------------------------
Support functions:
* -------------------------------------------------------------------------------------- */

NDDSUSERDllExport extern heartbeat_TelemetryData_c*
...
heartbeat_TelemetryData_cPluginSupport_copy_data(
    heartbeat_TelemetryData_c *out,
    const heartbeat_TelemetryData_c *in);
...
NDDSUSERDllExport extern RTIBool
heartbeat_TelemetryData_cPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream, 
    RTIBool skip_encapsulation,  
    RTIBool skip_sample, 
...
NDDSUSERDllExport extern RTIBool 
heartbeat_TelemetryData_cPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    heartbeat_TelemetryData_c * sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
NDDSUSERDllExport extern RTIBool 
heartbeat_TelemetryData_cPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    heartbeat_TelemetryData_c ** sample,
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
heartbeat_TelemetryData_cPlugin_new(void);

NDDSUSERDllExport extern void
heartbeat_TelemetryData_cPlugin_delete(struct PRESTypePlugin *);

#define heartbeat_SatelliteInfo_cPlugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
#define heartbeat_SatelliteInfo_cPlugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define heartbeat_SatelliteInfo_cPlugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

#define heartbeat_SatelliteInfo_cPlugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define heartbeat_SatelliteInfo_cPlugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

/* --------------------------------------------------------------------------------------
Support functions:
* -------------------------------------------------------------------------------------- */

NDDSUSERDllExport extern heartbeat_SatelliteInfo_c*
...
heartbeat_SatelliteInfo_cPluginSupport_copy_data(
    heartbeat_SatelliteInfo_c *out,
    const heartbeat_SatelliteInfo_c *in);
...
NDDSUSERDllExport extern RTIBool
heartbeat_SatelliteInfo_cPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream, 
    RTIBool skip_encapsulation,  
    RTIBool skip_sample, 
...
NDDSUSERDllExport extern RTIBool 
heartbeat_SatelliteInfo_cPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    heartbeat_SatelliteInfo_c * sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
NDDSUSERDllExport extern RTIBool 
heartbeat_SatelliteInfo_cPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    heartbeat_SatelliteInfo_c ** sample,
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
/* Plugin Functions */
NDDSUSERDllExport extern struct PRESTypePlugin*
heartbeat_SatelliteInfo_cPlugin_new(void);

NDDSUSERDllExport extern void
heartbeat_SatelliteInfo_cPlugin_delete(struct PRESTypePlugin *);

#define heartbeat_HeartbeatMessage_cPlugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
#define heartbeat_HeartbeatMessage_cPlugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define heartbeat_HeartbeatMessage_cPlugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

#define heartbeat_HeartbeatMessage_cPlugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define heartbeat_HeartbeatMessage_cPlugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

/* --------------------------------------------------------------------------------------
Support functions:
* -------------------------------------------------------------------------------------- */

NDDSUSERDllExport extern heartbeat_HeartbeatMessage_c*
...
heartbeat_HeartbeatMessage_cPluginSupport_copy_data(
    heartbeat_HeartbeatMessage_c *out,
    const heartbeat_HeartbeatMessage_c *in);
...
NDDSUSERDllExport extern RTIBool
heartbeat_HeartbeatMessage_cPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream, 
    RTIBool skip_encapsulation,  
    RTIBool skip_sample, 
...
NDDSUSERDllExport extern RTIBool 
heartbeat_HeartbeatMessage_cPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    heartbeat_HeartbeatMessage_c * sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
NDDSUSERDllExport extern RTIBool 
heartbeat_HeartbeatMessage_cPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    heartbeat_HeartbeatMessage_c ** sample,
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
/* Plugin Functions */
NDDSUSERDllExport extern struct PRESTypePlugin*
heartbeat_HeartbeatMessage_cPlugin_new(void);

NDDSUSERDllExport extern void
heartbeat_HeartbeatMessage_cPlugin_delete(struct PRESTypePlugin *);
...
#endif /* HeartbeatImplPlugin_816432136_h */
